...
class CartController extends GetxController implements GetxService {
  ...
  double calculationCart() {
    ...
    if (isFoodVariation) {
      print("isFoodVariation: $isFoodVariation");
      print("variationPrice: $_variationPrice");
      print("itemDiscountPrice: $_itemDiscountPrice");

      if (_variationPrice != 0) {
        _subTotal = (_variationPrice - _itemDiscountPrice);
      } else {
        _subTotal = (_itemPrice - _itemDiscountPrice);
      }

      print("subTotal (variation): $_subTotal");
    } else {
      print("isFoodVariation: $isFoodVariation");
      print("itemPrice: $_itemPrice");
      print("itemDiscountPrice: $_itemDiscountPrice");

      _subTotal = (_itemPrice - _itemDiscountPrice);

      print("subTotal (item): $_subTotal");
    }
