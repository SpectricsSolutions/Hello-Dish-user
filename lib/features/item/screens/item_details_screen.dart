        ...
        return GetBuilder<ItemController>(
          builder: (itemController) {
            ...
            if(itemController.item != null && itemController.variationIndex != null){
              ...
              print('===== PRICE DEBUG =====');
              print('Base item price: ${itemController.item!.price}');
              print('Variation type: $variationType');
              print('Selected variation price: $price');
              print('Price with discount: $priceWithDiscount');
              print('Price with quantity: $priceWithQuantity');
              print('Addons cost: $addonsCost');
              print('Final priceWithAddons: $priceWithAddons');
              print('======================');
              cartModel = CartModel(
