  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GetBuilder<ItemController>(builder: (itemController) {
        ...
        print('========== PRICE DEBUG ==========');
        print('Base item price: ${widget.item!.price}');
        print('variationPrice: $variationPrice');
        print('Price after variation: $price');
        print('Variation object: ${variation?.price}');
        print('Variation type: ${variation?.type}');
        print('================================');
